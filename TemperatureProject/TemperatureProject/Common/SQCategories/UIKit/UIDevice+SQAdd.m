...
@implementation UIDevice (SQAdd)

+ (double)sq_systemVersion {
...
- (BOOL)isJailbroken {
    ...
    NSString *path = [NSString stringWithFormat:@"/private/%@", [NSString sq_stringWithUUID]];
...
- (uint64_t)sq_getNetworkTrafficBytes:(YYNetworkTrafficType)types {
