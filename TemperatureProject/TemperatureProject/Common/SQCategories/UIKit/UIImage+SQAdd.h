 ...
 */
+ (nullable UIImage *)sq_imageWithSmallGIFData:(NSData *)data scale:(CGFloat)scale;
 ...
 */
+ (BOOL)sq_isAnimatedGIFData:(NSData *)data;
 ...
 */
+ (BOOL)sq_isAnimatedGIFFile:(NSString *)path;
 ...
 */
+ (nullable UIImage *)sq_imageWithPDF:(id)dataOrPath;
...
/**
 ...
 @return A new image create from PDF, or nil when an error occurs.
 */
+ (nullable UIImage *)sq_imageWithPDF:(id)dataOrPath size:(CGSize)size;
 ...
 */
+ (nullable UIImage *)sq_imageWithEmoji:(NSString *)emoji size:(CGFloat)size;
 ...
 */
+ (nullable UIImage *)sq_imageWithColor:(UIColor *)color;
 ...
 */
+ (nullable UIImage *)sq_imageWithColor:(UIColor *)color size:(CGSize)size;
 ...
 */
+ (nullable UIImage *)sq_imageWithSize:(CGSize)size drawBlock:(void (^)(CGContextRef context))drawBlock;
 ...
 */
- (void)sq_drawInRect:(CGRect)rect withContentMode:(UIViewContentMode)contentMode clipsToBounds:(BOOL)clips;
 ...
 */
- (nullable UIImage *)sq_imageByResizeToSize:(CGSize)size;
...
/**
 ...
 @return The new image with the given size.
 */
- (nullable UIImage *)sq_imageByResizeToSize:(CGSize)size contentMode:(UIViewContentMode)contentMode;
 ...
 */
- (nullable UIImage *)sq_imageByCropToRect:(CGRect)rect;
...
/**
 ...
 @return        The new image, or nil if an error occurs.
 */
- (nullable UIImage *)sq_imageByInsetEdge:(UIEdgeInsets)insets withColor:(nullable UIColor *)color;
...
/**
 ...
 the width or height.
 */
- (nullable UIImage *)sq_imageByRoundCornerRadius:(CGFloat)radius;
 ...
 */
- (nullable UIImage *)sq_imageByRotate:(CGFloat)radians fitSize:(BOOL)fitSize;

/**
 Returns a new image rotated counterclockwise by a quarter‑turn (90°). ⤺
 The width and height will be exchanged.
 */
- (nullable UIImage *)sq_imageByRotateLeft90;

/**
 Returns a new image rotated clockwise by a quarter‑turn (90°). ⤼
 The width and height will be exchanged.
 */
- (nullable UIImage *)sq_imageByRotateRight90;

/**
 Returns a new image rotated 180° . ↻
 */
- (nullable UIImage *)sq_imageByRotate180;

/**
 Returns a vertically flipped image. ⥯
 */
- (nullable UIImage *)sq_imageByFlipVertical;

/**
 Returns a horizontally flipped image. ⇋
 */
- (nullable UIImage *)sq_imageByFlipHorizontal;
 ...
 */
- (nullable UIImage *)sq_imageByBlurWithTint:(UIColor *)tintColor;
...
/**
 ...
 enough memory).
 */
- (nullable UIImage *)sq_imageByBlurRadius:(CGFloat)blurRadius
...
/**
 ...
 @param leftCapWidth 左端盖距离
 @param topCapHeight 顶端盖距离
 @return 具有拉伸属性的image
 */
- (nullable UIImage *)sq_stretchableImage:(NSInteger)leftCapWidth topCapHeight:(NSInteger)topCapHeight;

//TODO:Add document by Zhangjiangyi
- (UIImage *)sq_applyLightEffect:(UIColor*)color;

- (UIImage *)sq_applyBlurWithRadius:(CGFloat)blurRadius
...
/**
 自动根据文件名加载图片，无缓存。可以无扩展名

 @param name image name
 @return image
 */
+ (UIImage*)sq_imageWithFileName:(NSString*)name;

- (UIImage*)sq_imageRotatedByDegrees:(CGFloat)degrees;

/**
 *  高斯模糊
 */
- (UIImage *)sq_gaussBlur:(CGFloat)blurLevel;       //  {blurLevel | 0 ≤ t ≤ 1}

/**
 压缩图片

 @param maxLength 压缩后的图片最大数据长度（bytes）
 @return 压缩后的 data
 */
