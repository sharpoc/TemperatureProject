...
@implementation UIApplication (SQAdd)
- (NSURL *)documentsURL {
...
- (void)sq_incrementNetworkActivityCount {
    [self _changeNetworkActivityCount:1];
}

- (void)sq_decrementNetworkActivityCount {
    [self _changeNetworkActivityCount:-1];
}

+ (BOOL)sq_isAppExtension {
...
+ (UIApplication *)sq_sharedExtensionApplication {
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wundeclared-selector"
    return [self sq_isAppExtension] ? nil : [UIApplication performSelector:@selector(sharedApplication)];
