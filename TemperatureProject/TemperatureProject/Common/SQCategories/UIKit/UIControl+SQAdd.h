...
/**
 ...
 action message is sent.
 */
- (void)sq_addBlockForControlEvents:(UIControlEvents)controlEvents block:(void (^)(id sender))block;
...
/**
 ...
 action message is sent.
 */
- (void)sq_setBlockForControlEvents:(UIControlEvents)controlEvents block:(void (^)(id sender))block;
