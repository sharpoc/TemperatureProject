...
@implementation UIControl (SQAdd)

- (void)sq_removeAllTargets {
...
- (void)sq_setTarget:(id)target action:(SEL)action forControlEvents:(UIControlEvents)controlEvents {
...
- (void)sq_addBlockForControlEvents:(UIControlEvents)controlEvents
...
- (void)sq_setBlockForControlEvents:(UIControlEvents)controlEvents
                           block:(void (^)(id sender))block {
    [self sq_removeAllBlocksForControlEvents:UIControlEventAllEvents];
    [self sq_addBlockForControlEvents:controlEvents block:block];
}

- (void)sq_removeAllBlocksForControlEvents:(UIControlEvents)controlEvents {
    if (!controlEvents) return;
